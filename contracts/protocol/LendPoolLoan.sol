    ...
    IERC721ReceiverUpgradeable
{
    ...
    function repayLoan(
        ...
        require(
            ...
            Errors.LP_INVALID_USER_NFT_AMOUNT
        );
        _userNftCollateral[loan.borrower][loan.nftAsset] -= 1;

        require(
            _nftTotalCollateral[loan.nftAsset] >= 1,
            Errors.LP_INVALID_NFT_AMOUNT
        );
        _nftTotalCollateral[loan.nftAsset] -= 1;
    ...
    function liquidateLoanNFTX(
        ...
        require(
            IERC721Upgradeable(loan.nftAsset).ownerOf(loan.nftTokenId) ==
                address(this),
            "Invalid Call"
        );
     ...
     * @inheritdoc ILendPoolLoan
     */
    function getLoanIdTracker()
        external
        view
        override
        returns (CountersUpgradeable.Counter memory)
    {
