...
task("pool-admin:set-reserve-active", "Doing Reserve active task")
  ...
  .setAction(async ({ pool, asset, state }, DRE) => {
    ...
    const reserveConfig = await unlockdDataProvider.getReserveConfigurationData(
      asset
    );
    ...
    const newReserveConfig =
      await unlockdDataProvider.getReserveConfigurationData(asset);
...
task("pool-admin:set-nft-active", "Doing NFT active task")
  ...
  .setAction(async ({ pool, asset, state }, DRE) => {
    ...
    const curNftConfig = await unlockdDataProvider.getNftConfigurationData(
      asset
    );
    ...
    const newNftConfig = await unlockdDataProvider.getNftConfigurationData(
      asset
    );
